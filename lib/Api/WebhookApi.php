...
/**
     ...
     * nový webhook
     *
     * @param  \belenka\Raynetcrm\Model\WebhookInsertDto $webhook_insert_dto webhook_insert_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\WebhookInsert201Response
     */
     ...
     * nový webhook
     *
     * @param  \belenka\Raynetcrm\Model\WebhookInsertDto $webhook_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\WebhookInsert201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookInsertWithHttpInfo($webhook_insert_dto = null, string $contentType = self::contentTypes['webhookInsert'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\belenka\Raynetcrm\Model\WebhookInsert201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\WebhookInsert201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\WebhookInsert201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\WebhookInsert201Response';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\WebhookInsert201Response',
    ...
    public function webhookInsertRequest($webhook_insert_dto = null, string $contentType = self::contentTypes['webhookInsert'][0])
    {
        ...
        if (isset($webhook_insert_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($webhook_insert_dto));
            } else {
     ...
     *
     * @param  \belenka\Raynetcrm\Model\WebhookTechnicalContactEditDto $webhook_technical_contact_edit_dto webhook_technical_contact_edit_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\WebhookTechnicalContactEdit200Response
     */
     ...
     * upravení technického kontaktu
     *
     * @param  \belenka\Raynetcrm\Model\WebhookTechnicalContactEditDto $webhook_technical_contact_edit_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookTechnicalContactEdit'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\WebhookTechnicalContactEdit200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookTechnicalContactEditWithHttpInfo($webhook_technical_contact_edit_dto = null, string $contentType = self::contentTypes['webhookTechnicalContactEdit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\WebhookTechnicalContactEdit200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\WebhookTechnicalContactEdit200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\WebhookTechnicalContactEdit200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\WebhookTechnicalContactEdit200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\WebhookTechnicalContactEdit200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function webhookTechnicalContactEditRequest($webhook_technical_contact_edit_dto = null, string $contentType = self::contentTypes['webhookTechnicalContactEdit'][0])
    {
        ...
        if (isset($webhook_technical_contact_edit_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($webhook_technical_contact_edit_dto));
            } else {
