...
/**
     ...
     *
     * @param  int $lead_id ID leadu (required)
     * @param  \belenka\Raynetcrm\Model\LeadEditDto $lead_edit_dto lead_edit_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\LeadEdit200Response
     */
     ...
     *
     * @param  int $lead_id ID leadu (required)
     * @param  \belenka\Raynetcrm\Model\LeadEditDto $lead_edit_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadEdit'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\LeadEdit200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function leadEditWithHttpInfo($lead_id, $lead_edit_dto = null, string $contentType = self::contentTypes['leadEdit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\LeadEdit200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\LeadEdit200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\LeadEdit200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\LeadEdit200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\LeadEdit200Response',
    ...
    public function leadEditRequest($lead_id, $lead_edit_dto = null, string $contentType = self::contentTypes['leadEdit'][0])
    {
        ...
        if (isset($lead_edit_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($lead_edit_dto));
            } else {
     ...
     * nový lead
     *
     * @param  \belenka\Raynetcrm\Model\LeadInsertDto $lead_insert_dto lead_insert_dto (optional)
     ...
     * nový lead
     *
     * @param  \belenka\Raynetcrm\Model\LeadInsertDto $lead_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['leadInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function leadInsertRequest($lead_insert_dto = null, string $contentType = self::contentTypes['leadInsert'][0])
    {
        ...
        if (isset($lead_insert_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($lead_insert_dto));
            } else {
