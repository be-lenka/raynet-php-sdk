...
/**
     ...
     * @return \belenka\Raynetcrm\Model\PostDelete201Response
     */
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\PostDelete201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function postDeleteWithHttpInfo($entity_name, $entity_id, $post_id, string $contentType = self::contentTypes['postDelete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\belenka\Raynetcrm\Model\PostDelete201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\PostDelete201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\PostDelete201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\PostDelete201Response';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\PostDelete201Response',
     ...
     * @param  string $entity_name Název entity (podporované hodnoty jsou: &#x60;company&#x60;, &#x60;lead&#x60;, &#x60;person&#x60;, &#x60;businessCase&#x60;, &#x60;offer&#x60;, &#x60;salesOrder&#x60;, &#x60;product&#x60;, &#x60;priceList&#x60;, &#x60;project&#x60;, &#x60;invoice&#x60;, &#x60;task&#x60;, &#x60;email&#x60;, &#x60;event&#x60;, &#x60;letter&#x60;, &#x60;phoneCall&#x60;, &#x60;meeting&#x60;) (required)
     * @param  int $entity_id ID entity (required)
     * @param  \belenka\Raynetcrm\Model\PostInsertDto $post_insert_dto post_insert_dto (optional)
     ...
     * @param  string $entity_name Název entity (podporované hodnoty jsou: &#x60;company&#x60;, &#x60;lead&#x60;, &#x60;person&#x60;, &#x60;businessCase&#x60;, &#x60;offer&#x60;, &#x60;salesOrder&#x60;, &#x60;product&#x60;, &#x60;priceList&#x60;, &#x60;project&#x60;, &#x60;invoice&#x60;, &#x60;task&#x60;, &#x60;email&#x60;, &#x60;event&#x60;, &#x60;letter&#x60;, &#x60;phoneCall&#x60;, &#x60;meeting&#x60;) (required)
     * @param  int $entity_id ID entity (required)
     * @param  \belenka\Raynetcrm\Model\PostInsertDto $post_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function postInsertRequest($entity_name, $entity_id, $post_insert_dto = null, string $contentType = self::contentTypes['postInsert'][0])
    {
        ...
        if (isset($post_insert_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($post_insert_dto));
            } else {
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\WatcherDelete201Response
     */
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\WatcherDelete201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function watcherDeleteWithHttpInfo($entity_name, $entity_id, $person_id, string $contentType = self::contentTypes['watcherDelete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\belenka\Raynetcrm\Model\WatcherDelete201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\WatcherDelete201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\WatcherDelete201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\WatcherDelete201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\WatcherDelete201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
