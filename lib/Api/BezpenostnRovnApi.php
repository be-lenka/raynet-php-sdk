...
/**
     ...
     *
     * @param  \belenka\Raynetcrm\Model\SecurityLevelInsertDto $security_level_insert_dto security_level_insert_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\Insert201Response
     */
     ...
     * nová bezpečnostní úroveň
     *
     * @param  \belenka\Raynetcrm\Model\SecurityLevelInsertDto $security_level_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityLevelInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\Insert201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityLevelInsertWithHttpInfo($security_level_insert_dto = null, string $contentType = self::contentTypes['securityLevelInsert'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\belenka\Raynetcrm\Model\Insert201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\Insert201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\Insert201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\Insert201Response';
    ...
    public function securityLevelInsertRequest($security_level_insert_dto = null, string $contentType = self::contentTypes['securityLevelInsert'][0])
    {
        ...
        if (isset($security_level_insert_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($security_level_insert_dto));
            } else {
     ...
     *
     * @param  int $security_level_id ID bezpečnostní úrovně (required)
     * @param  \belenka\Raynetcrm\Model\SecurityLevelMultiAddUserEditDto $security_level_multi_add_user_edit_dto security_level_multi_add_user_edit_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\SecurityLevelMultiAddUserEdit201Response
     */
     ...
     *
     * @param  int $security_level_id ID bezpečnostní úrovně (required)
     * @param  \belenka\Raynetcrm\Model\SecurityLevelMultiAddUserEditDto $security_level_multi_add_user_edit_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityLevelMultiAddUserEdit'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\SecurityLevelMultiAddUserEdit201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityLevelMultiAddUserEditWithHttpInfo($security_level_id, $security_level_multi_add_user_edit_dto = null, string $contentType = self::contentTypes['securityLevelMultiAddUserEdit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\belenka\Raynetcrm\Model\SecurityLevelMultiAddUserEdit201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\SecurityLevelMultiAddUserEdit201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\SecurityLevelMultiAddUserEdit201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\SecurityLevelMultiAddUserEdit201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\SecurityLevelMultiAddUserEdit201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function securityLevelMultiAddUserEditRequest($security_level_id, $security_level_multi_add_user_edit_dto = null, string $contentType = self::contentTypes['securityLevelMultiAddUserEdit'][0])
    {
        ...
        if (isset($security_level_multi_add_user_edit_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($security_level_multi_add_user_edit_dto));
            } else {
     ...
     *
     * @param  int $security_level_id ID bezpečnostní úrovně (required)
     * @param  \belenka\Raynetcrm\Model\SecurityLevelMultiRemoveUserEditDto $security_level_multi_remove_user_edit_dto security_level_multi_remove_user_edit_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\SecurityLevelMultiRemoveUserEdit201Response
     */
     ...
     *
     * @param  int $security_level_id ID bezpečnostní úrovně (required)
     * @param  \belenka\Raynetcrm\Model\SecurityLevelMultiRemoveUserEditDto $security_level_multi_remove_user_edit_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityLevelMultiRemoveUserEdit'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\SecurityLevelMultiRemoveUserEdit201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityLevelMultiRemoveUserEditWithHttpInfo($security_level_id, $security_level_multi_remove_user_edit_dto = null, string $contentType = self::contentTypes['securityLevelMultiRemoveUserEdit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\belenka\Raynetcrm\Model\SecurityLevelMultiRemoveUserEdit201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\SecurityLevelMultiRemoveUserEdit201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\SecurityLevelMultiRemoveUserEdit201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\SecurityLevelMultiRemoveUserEdit201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\SecurityLevelMultiRemoveUserEdit201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function securityLevelMultiRemoveUserEditRequest($security_level_id, $security_level_multi_remove_user_edit_dto = null, string $contentType = self::contentTypes['securityLevelMultiRemoveUserEdit'][0])
    {
        ...
        if (isset($security_level_multi_remove_user_edit_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($security_level_multi_remove_user_edit_dto));
            } else {
