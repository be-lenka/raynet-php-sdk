...
$apiInstance = new belenka\Raynetcrm\Api\KlientiApi(
...
| **company_id** | **int**| ID klienta | |
| **address_id** | **int**| ID adresy | |
| **company_address_edit_dto** | [**\belenka\Raynetcrm\Model\CompanyAddressEditDto**](../Model/CompanyAddressEditDto.md)|  | [optional] |
...
```php
companyAddressInsert($company_id, $company_address_insert_dto): \belenka\Raynetcrm\Model\Insert201Response
```
...
| ------------- | ------------- | ------------- | ------------- |
| **company_id** | **int**| ID klienta | |
| **company_address_insert_dto** | [**\belenka\Raynetcrm\Model\CompanyAddressInsertDto**](../Model/CompanyAddressInsertDto.md)|  | [optional] |
...
| ------------- | ------------- | ------------- | ------------- |
| **company_id** | **int**| ID klienta | |
| **company_edit_dto** | [**\belenka\Raynetcrm\Model\CompanyEditDto**](../Model/CompanyEditDto.md)|  | [optional] |
...
```php
companyInsert($company_insert_dto): \belenka\Raynetcrm\Model\Insert201Response
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **company_insert_dto** | [**\belenka\Raynetcrm\Model\CompanyInsertDto**](../Model/CompanyInsertDto.md)|  | [optional] |
...
$company_relationship_edit_dto = {"notice":"Zařazení v rámci holdingu"}; // \belenka\Raynetcrm\Model\CompanyRelationshipEditDto
...
| **company_relationship_edit_dto** | [**\belenka\Raynetcrm\Model\CompanyRelationshipEditDto**](../Model/CompanyRelationshipEditDto.md)|  | [optional] |
...
```php
companyRelationshipInsert($company_id, $company_relationship_insert_dto): \belenka\Raynetcrm\Model\Insert201Response
```
...
$company_id = 123; // int | ID klienta
$company_relationship_insert_dto = {"companyJoin":5,"companyJoinType":"parent","notice":"Zařazení v rámci holdingu"}; // \belenka\Raynetcrm\Model\CompanyRelationshipInsertDto
...
| ------------- | ------------- | ------------- | ------------- |
| **company_id** | **int**| ID klienta | |
| **company_relationship_insert_dto** | [**\belenka\Raynetcrm\Model\CompanyRelationshipInsertDto**](../Model/CompanyRelationshipInsertDto.md)|  | [optional] |
...
$company_id = 123; // int | ID klienta
$company_tag_delete_dto = {"tag":"muj tag"}; // \belenka\Raynetcrm\Model\CompanyTagDeleteDto
...
| ------------- | ------------- | ------------- | ------------- |
| **company_id** | **int**| ID klienta | |
| **company_tag_delete_dto** | [**\belenka\Raynetcrm\Model\CompanyTagDeleteDto**](../Model/CompanyTagDeleteDto.md)|  | [optional] |
...
$company_id = 123; // int | ID klienta
$company_tag_insert_dto = {"tag":"muj tag"}; // \belenka\Raynetcrm\Model\CompanyTagInsertDto
...
| ------------- | ------------- | ------------- | ------------- |
| **company_id** | **int**| ID klienta | |
| **company_tag_insert_dto** | [**\belenka\Raynetcrm\Model\CompanyTagInsertDto**](../Model/CompanyTagInsertDto.md)|  | [optional] |
