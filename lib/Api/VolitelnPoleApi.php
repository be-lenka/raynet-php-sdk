...
/**
     ...
     * @return \belenka\Raynetcrm\Model\CustomFieldEnumDelete200Response
     */
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\CustomFieldEnumDelete200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function customFieldConfigDeleteWithHttpInfo($entity_name, $field_name, string $contentType = self::contentTypes['customFieldConfigDelete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\CustomFieldEnumDelete200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\CustomFieldEnumDelete200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\CustomFieldEnumDelete200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\CustomFieldEnumDelete200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\CustomFieldEnumDelete200Response',
     ...
     * @param  \belenka\Raynetcrm\Model\CustomFieldConfigEditDto $custom_field_config_edit_dto custom_field_config_edit_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\CustomFieldEnumEdit200Response
     */
     ...
     * @param  string $entity_name Název entity, ve které se má volitelné pole upravit (required)
     * @param  string $field_name Kód volitelného pole, které se má upravit (required)
     * @param  \belenka\Raynetcrm\Model\CustomFieldConfigEditDto $custom_field_config_edit_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customFieldConfigEdit'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\CustomFieldEnumEdit200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function customFieldConfigEditWithHttpInfo($entity_name, $field_name, $custom_field_config_edit_dto = null, string $contentType = self::contentTypes['customFieldConfigEdit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\CustomFieldEnumEdit200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\CustomFieldEnumEdit200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\CustomFieldEnumEdit200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\CustomFieldEnumEdit200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\CustomFieldEnumEdit200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\CustomFieldConfigGet200Response
     */
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\CustomFieldConfigGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function customFieldConfigGetWithHttpInfo(string $contentType = self::contentTypes['customFieldConfigGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\CustomFieldConfigGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\CustomFieldConfigGet200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\CustomFieldConfigGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\CustomFieldConfigGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\CustomFieldConfigGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \belenka\Raynetcrm\Model\CustomFieldConfigInsertDto $custom_field_config_insert_dto custom_field_config_insert_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\CustomFieldConfigInsert201Response
     */
     ...
     *
     * @param  string $entity_name Název entity, ke které se volitelné pole založí (podporované hodnoty jsou: &#x60;company&#x60;, &#x60;lead&#x60;, &#x60;person&#x60;, &#x60;businessCase&#x60;, &#x60;offer&#x60;, &#x60;salesOrder&#x60;, &#x60;product&#x60;, &#x60;project&#x60;, &#x60;task&#x60;, &#x60;email&#x60;, &#x60;event&#x60;, &#x60;letter&#x60;, &#x60;phoneCall&#x60;, &#x60;meeting&#x60;) (required)
     * @param  \belenka\Raynetcrm\Model\CustomFieldConfigInsertDto $custom_field_config_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customFieldConfigInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\CustomFieldConfigInsert201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function customFieldConfigInsertWithHttpInfo($entity_name, $custom_field_config_insert_dto = null, string $contentType = self::contentTypes['customFieldConfigInsert'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\belenka\Raynetcrm\Model\CustomFieldConfigInsert201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\CustomFieldConfigInsert201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\CustomFieldConfigInsert201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\CustomFieldConfigInsert201Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\CustomFieldConfigInsert201Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \belenka\Raynetcrm\Model\CustomFieldEnumDeleteDto $custom_field_enum_delete_dto custom_field_enum_delete_dto (optional)
     ...
     * @param  string $entity_name Název entity, která volitelné pole obsahuje (required)
     * @param  string $field_name Klíč volitelného pole (required)
     * @param  \belenka\Raynetcrm\Model\CustomFieldEnumDeleteDto $custom_field_enum_delete_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customFieldEnumDelete'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $entity_name Název entity, která volitelné pole obsahuje (required)
     * @param  string $field_name Klíč volitelného pole (required)
     * @param  \belenka\Raynetcrm\Model\CustomFieldEnumEditDto $custom_field_enum_edit_dto custom_field_enum_edit_dto (optional)
     ...
     * @param  string $entity_name Název entity, která volitelné pole obsahuje (required)
     * @param  string $field_name Klíč volitelného pole (required)
     * @param  \belenka\Raynetcrm\Model\CustomFieldEnumEditDto $custom_field_enum_edit_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customFieldEnumEdit'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\CustomFieldEnumGet200Response
     */
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\CustomFieldEnumGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function customFieldEnumGetWithHttpInfo($entity_name, $field_name, string $contentType = self::contentTypes['customFieldEnumGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\CustomFieldEnumGet200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\CustomFieldEnumGet200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\CustomFieldEnumGet200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\CustomFieldEnumGet200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\CustomFieldEnumGet200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $entity_name Název entity, která volitelné pole obsahuje (required)
     * @param  string $field_name Klíč volitelného pole (required)
     * @param  \belenka\Raynetcrm\Model\CustomFieldEnumInsertDto $custom_field_enum_insert_dto custom_field_enum_insert_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\CustomFieldEnumInsert200Response
     */
     ...
     * @param  string $entity_name Název entity, která volitelné pole obsahuje (required)
     * @param  string $field_name Klíč volitelného pole (required)
     * @param  \belenka\Raynetcrm\Model\CustomFieldEnumInsertDto $custom_field_enum_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customFieldEnumInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\CustomFieldEnumInsert200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function customFieldEnumInsertWithHttpInfo($entity_name, $field_name, $custom_field_enum_insert_dto = null, string $contentType = self::contentTypes['customFieldEnumInsert'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\CustomFieldEnumInsert200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\CustomFieldEnumInsert200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\CustomFieldEnumInsert200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\CustomFieldEnumInsert200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\CustomFieldEnumInsert200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
