...
/**
     ...
     *
     * @param  int $phone_call_id ID telefonátu (required)
     * @param  \belenka\Raynetcrm\Model\PhoneCallEditDto $phone_call_edit_dto phone_call_edit_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\PhoneCallEdit200Response
     */
     ...
     *
     * @param  int $phone_call_id ID telefonátu (required)
     * @param  \belenka\Raynetcrm\Model\PhoneCallEditDto $phone_call_edit_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['phoneCallEdit'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\PhoneCallEdit200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function phoneCallEditWithHttpInfo($phone_call_id, $phone_call_edit_dto = null, string $contentType = self::contentTypes['phoneCallEdit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\PhoneCallEdit200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\PhoneCallEdit200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\PhoneCallEdit200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\PhoneCallEdit200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\PhoneCallEdit200Response',
    ...
    public function phoneCallEditRequest($phone_call_id, $phone_call_edit_dto = null, string $contentType = self::contentTypes['phoneCallEdit'][0])
    {
        ...
        if (isset($phone_call_edit_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($phone_call_edit_dto));
            } else {
     ...
     * nový telefonát
     *
     * @param  \belenka\Raynetcrm\Model\PhonecallInsertDto $phonecall_insert_dto phonecall_insert_dto (optional)
     ...
     * nový telefonát
     *
     * @param  \belenka\Raynetcrm\Model\PhonecallInsertDto $phonecall_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['phoneCallInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function phoneCallInsertRequest($phonecall_insert_dto = null, string $contentType = self::contentTypes['phoneCallInsert'][0])
    {
        ...
        if (isset($phonecall_insert_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($phonecall_insert_dto));
            } else {
