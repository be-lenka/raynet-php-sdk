...
| ------------- | ------------- | ------------- | ------------- |
| **email_id** | **int**| ID emailu | |
| **email_edit_dto** | [**\belenka\Raynetcrm\Model\EmailEditDto**](../Model/EmailEditDto.md)|  | [optional] |

### Return type

[**\belenka\Raynetcrm\Model\EmailEdit200Response**](../Model/EmailEdit200Response.md)
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **email_insert_dto** | [**\belenka\Raynetcrm\Model\EmailInsertDto**](../Model/EmailInsertDto.md)|  | [optional] |
