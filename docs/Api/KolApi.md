...
$apiInstance = new belenka\Raynetcrm\Api\KolApi(
...
```php
taskEdit($task_id, $task_edit_dto): \belenka\Raynetcrm\Model\TaskEdit200Response
```
...
| ------------- | ------------- | ------------- | ------------- |
| **task_id** | **int**| ID úkolu | |
| **task_edit_dto** | [**\belenka\Raynetcrm\Model\TaskEditDto**](../Model/TaskEditDto.md)|  | [optional] |

### Return type

[**\belenka\Raynetcrm\Model\TaskEdit200Response**](../Model/TaskEdit200Response.md)
...
```php
taskInsert($task_insert_dto): \belenka\Raynetcrm\Model\Insert201Response
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **task_insert_dto** | [**\belenka\Raynetcrm\Model\TaskInsertDto**](../Model/TaskInsertDto.md)|  | [optional] |
