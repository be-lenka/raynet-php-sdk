...
/**
     ...
     *
     * @param  int $email_id ID emailu (required)
     * @param  \belenka\Raynetcrm\Model\EmailEditDto $email_edit_dto email_edit_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\EmailEdit200Response
     */
     ...
     *
     * @param  int $email_id ID emailu (required)
     * @param  \belenka\Raynetcrm\Model\EmailEditDto $email_edit_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emailEdit'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\EmailEdit200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function emailEditWithHttpInfo($email_id, $email_edit_dto = null, string $contentType = self::contentTypes['emailEdit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\EmailEdit200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\EmailEdit200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\EmailEdit200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\EmailEdit200Response';
    ...
    public function emailEditRequest($email_id, $email_edit_dto = null, string $contentType = self::contentTypes['emailEdit'][0])
    {
        ...
        if (isset($email_edit_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($email_edit_dto));
            } else {
     ...
     * nový email
     *
     * @param  \belenka\Raynetcrm\Model\EmailInsertDto $email_insert_dto email_insert_dto (optional)
     ...
     * nový email
     *
     * @param  \belenka\Raynetcrm\Model\EmailInsertDto $email_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['emailInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function emailInsertRequest($email_insert_dto = null, string $contentType = self::contentTypes['emailInsert'][0])
    {
        ...
        if (isset($email_insert_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($email_insert_dto));
            } else {
