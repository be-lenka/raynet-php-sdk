...
/**
     ...
     * @param  \belenka\Raynetcrm\Model\AttachmentInsertDto $attachment_insert_dto attachment_insert_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\AttachmentInsert201Response
     */
     ...
     * @param  string $entity_name Název entity (podporované hodnoty jsou: &#x60;company&#x60;, &#x60;lead&#x60;, &#x60;person&#x60;, &#x60;businessCase&#x60;, &#x60;offer&#x60;, &#x60;salesOrder&#x60;, &#x60;product&#x60;, &#x60;project&#x60;, &#x60;invoice&#x60;, &#x60;task&#x60;, &#x60;email&#x60;, &#x60;event&#x60;, &#x60;letter&#x60;, &#x60;phoneCall&#x60;, &#x60;meeting&#x60;) (required)
     * @param  int $entity_id ID entity (required)
     * @param  \belenka\Raynetcrm\Model\AttachmentInsertDto $attachment_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['attachmentInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\AttachmentInsert201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function attachmentInsertWithHttpInfo($entity_name, $entity_id, $attachment_insert_dto = null, string $contentType = self::contentTypes['attachmentInsert'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\belenka\Raynetcrm\Model\AttachmentInsert201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\AttachmentInsert201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\AttachmentInsert201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\AttachmentInsert201Response';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\AttachmentInsert201Response',
    ...
    public function attachmentInsertRequest($entity_name, $entity_id, $attachment_insert_dto = null, string $contentType = self::contentTypes['attachmentInsert'][0])
    {
        ...
        if (isset($attachment_insert_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($attachment_insert_dto));
            } else {
     ...
     * @param  \belenka\Raynetcrm\Model\AttachmentInsertCustomFieldDto $attachment_insert_custom_field_dto attachment_insert_custom_field_dto (optional)
     ...
     * @param  int $entity_id ID entity (required)
     * @param  string $custom_field_id Klíč (name) volitelného pole (required)
     * @param  \belenka\Raynetcrm\Model\AttachmentInsertCustomFieldDto $attachment_insert_custom_field_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['attachmentInsertCustomField'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function attachmentInsertCustomFieldRequest($entity_name, $entity_id, $custom_field_id, $attachment_insert_custom_field_dto = null, string $contentType = self::contentTypes['attachmentInsertCustomField'][0])
    {
        ...
        if (isset($attachment_insert_custom_field_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($attachment_insert_custom_field_dto));
            } else {
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\FileUploadEdit200Response
     */
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\FileUploadEdit200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function fileUploadEditWithHttpInfo($file, string $contentType = self::contentTypes['fileUploadEdit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\FileUploadEdit200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\FileUploadEdit200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\FileUploadEdit200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\FileUploadEdit200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\belenka\Raynetcrm\Model\FileUploadEdit200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
