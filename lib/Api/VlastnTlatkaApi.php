...
/**
     ...
     *
     * @param  \belenka\Raynetcrm\Model\CustomButtonInsertDto $custom_button_insert_dto custom_button_insert_dto (optional)
     ...
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \belenka\Raynetcrm\Model\CustomButtonInsert201Response
     */
     ...
     * Nové vlastní tlačítko
     *
     * @param  \belenka\Raynetcrm\Model\CustomButtonInsertDto $custom_button_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customButtonInsert'] to see the possible values for this operation
     *
     * @throws \belenka\Raynetcrm\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \belenka\Raynetcrm\Model\CustomButtonInsert201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function customButtonInsertWithHttpInfo($custom_button_insert_dto = null, string $contentType = self::contentTypes['customButtonInsert'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\belenka\Raynetcrm\Model\CustomButtonInsert201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\belenka\Raynetcrm\Model\CustomButtonInsert201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\belenka\Raynetcrm\Model\CustomButtonInsert201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\belenka\Raynetcrm\Model\CustomButtonInsert201Response';
    ...
    public function customButtonInsertRequest($custom_button_insert_dto = null, string $contentType = self::contentTypes['customButtonInsert'][0])
    {
        ...
        if (isset($custom_button_insert_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($custom_button_insert_dto));
            } else {
